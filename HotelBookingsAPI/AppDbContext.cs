...
namespace HotelBookingsAPI
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Hotel>().Property(h => h.HotelID).IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            ...
            builder.Entity<Room>().Property(r => r.RoomID).IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            ...
            builder.Entity<Booking>().Property(b => b.BookingID).IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
