...
namespace HotelBookingsAPI.Controllers
{
    ...
    public class HotelsController : Controller
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<Hotel>> GetAllAsync([FromQuery]string searchtext = "")
        {
            var hotels = await hotelService.ListAsync(searchtext);
            return hotels;
        }
        [HttpGet]
        [Route("id")]
        ...
        {
            var hotels = await hotelService.GetHotelAsync(id);
            return hotels;
        }
